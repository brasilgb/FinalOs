                  ...
                  <TableRow key={schedule.id}>
                    ...
                    <TableCell className='flex justify-end gap-2'>
                      ...
                      <Button asChild size="icon" className="bg-green-500 hover:bg-green-500 text-white">
                        <a target='_blank' href={`https://wa.me/${schedule.user.whatsapp}?text=${schedule.service} - ${schedule.customer.street}, ${schedule.customer.number}, ${schedule.customer.complement}, ${schedule.customer.district}, ${schedule.customer.city} - ${schedule.customer.state}`}>
